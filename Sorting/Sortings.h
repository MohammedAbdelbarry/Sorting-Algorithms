...
*/
/**
* @namespace sort A namespace containing a collection of sorting algorithms.
*/
namespace sort {
    ...
    */
    ...
    void insertionSort(RandomAccessIterator first, RandomAccessIterator last, Comparator comparator) {
        for (auto it1 = first + 1; it1 < last; it1++) {
            auto it2 = it1;
            while (it2 > first && comparator(*it2, *(it2 - 1))) {
                swapIteratorData(it2, it2 - 1);
                it2--;
            }
        }
    }
